...
class LMDataset(Dataset):
    ...
    def __init__(
        ...
        self.filter_seen_sampling = filter_seen_sampling
        self.data = (
...
class CausalLMDataset(LMDataset):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            gamma=gamma,
            filter_seen_sampling=filter_seen_sampling,
